...
await writeFile(path.join(output, "package.json"), JSON.stringify({ name: "zhonghua-mingli-desktop", productName: "中華命理 AI", version: "1.3.0", description: "本機易經、八字與紫微排盤，DeepSeek AI 解讀", author: "Tony Huang", main: "main.cjs", private: true }, null, 2));
